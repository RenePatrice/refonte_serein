// ==============================================================================
// SEREIN-GE : Préréglages de police pilotables depuis le module Apparence.
// 'default' correspond à la police actuelle (Inter/Outfit, déjà chargée
// statiquement dans layout.tsx) — aucun chargement dynamique nécessaire pour
// ce préréglage. Les autres injectent leur propre <link> Google Fonts.
// ==============================================================================
